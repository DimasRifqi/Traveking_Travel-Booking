@include('components/navbar')
    ...
    <div class="hero overlay">
        ...
        <div class="img-bg rellax">
            <img src="img/FotoIndex/FotoHeader.jpg" alt="Image" class="img-fluid">
        </div>
            ...
            <div class="row align-items-center justify-content-start">
                <div class="col-lg-5">
                    ...
                    <div data-aos="fade-up">
                        <a href="https://youtu.be/ay-KbtIza4E?si=V-KMhDkFgtoA_e2E" class="play-button align-items-center d-flex glightbox3" >
